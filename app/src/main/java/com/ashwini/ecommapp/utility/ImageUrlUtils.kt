 ...
 */
class ImageUrlUtils {
    val wishlistImageUri: ArrayList<String> = TODO()
    val cartListImageUri: ArrayList<String> = TODO()
    // Methods for Wishlist
    fun addWishlistImageUri(wishlistImageUri: String?) {
        this.wishlistImageUri.add(0, wishlistImageUri!!)
    }

    fun removeWishlistImageUri(position: Int) {
    ...
    // Methods for Cart
    fun addCartListImageUri(wishlistImageUri: String?) {
    ...
    companion object {
        var wishlistImageUri = ArrayList<String>()
        var cartListImageUri = ArrayList<String>()
        ...
        fun getGroceryUrls(): Array<String> {
            return arrayOf(
        ...
        fun getDairyBeveragesUrls(): Array<String> {
            return arrayOf(
        ...
        fun getPackagedFoodUrls(): Array<String> {
            return arrayOf(
